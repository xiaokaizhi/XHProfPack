 ...
 * http://localhost/githubelite/bfwphpapp/evaluate/app.php?target=Mod_xhproftest
 */
class Mod_xhproftest extends Mod {
	public function run() {
		...
		$uri = "http://$host/githubredy/bfwphpapp/evaluate/include/xhprof/xhprof_html/index.php";
