		...
		<div class="row">				
			<div class="span2">				
				<aside class="left-sidebar">										
					<div class="widget">
						<p class="widgetheading">统计分析图</p>
							<ul class="cat">
								<li><i class="icon-angle-right"></i> <a href="./app.php?target=mod_statline">统计图test</a></li>
							</ul>
					</div>
				</aside>
			</div>
