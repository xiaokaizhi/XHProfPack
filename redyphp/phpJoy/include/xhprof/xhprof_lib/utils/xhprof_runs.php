...
class XHProfRuns_Default implements iXHProfRuns {
  ...
  /**
   * refactor by @tongzhen
   * get data from db
   * bfwphpapp/resqueshow
   */
  public function get_run_refactor($run_id, $type, &$run_desc) {
	...
	$where = "id ={$_REQUEST['run']}";
	$fields = 'xhprof_data';
	$data = $instance->get($where, $fields);
	
	$contents = '';
	if(isset($data['xhprof_data']) && !empty($data['xhprof_data'])){
		$contents = $data['xhprof_data'];
	}
	return unserialize($contents);
  }
